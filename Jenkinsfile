        ...
        stage('Build image') {
            steps {
                script {
                    ...
                    try {
                        sh "docker build -t adnan021/tud-frontend-docker:${tagName} -t adnan021/tud-frontend-docker:latest -t adnan021/tud-frontend-docker:${env.BUILD_NUMBER} ."
                    } catch (Exception e) {
                        now = new Date()
                    ...
                    sh "docker push adnan021/tud-frontend-docker:${tagName}"
                    sh "docker push adnan021/tud-frontend-docker:latest"
                    sh "docker push adnan021/tud-frontend-docker:${env.BUILD_NUMBER}"
                }
            }
        }
